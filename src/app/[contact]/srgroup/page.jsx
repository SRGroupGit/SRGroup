...
import heroImage from '@/app/(featured)/SRBusinessHub/hero0.avif';

export default function Page() {
  return (
    <div className='min-h-screen bg-white mt-[110px] pb-10'>
      <div className='mx-auto w-full max-w-lg px-4 pt-6'>
        <div className='relative flex items-center justify-center overflow-hidden'></div>
        <div className='mt-6 text-center'>
          <h1 className='text-5xl font-semibold text-blue-200'>
            Company Representative
          </h1>
          <p className='text-xl mt-2 text-gray-800'>SR Group</p>
        </div>
