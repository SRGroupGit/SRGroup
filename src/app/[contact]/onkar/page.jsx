  ...
  return (
    <div className='min-h-screen bg-white mt-[110px] pb-10'>
      <div className='mx-auto w-full max-w-lg px-4 pt-6'>
        ...
        <div className='bg-gray-100 rounded-xl p-6 mt-8 gap-5 flex flex-col '>
          <p className='text-2xl mt-2 font-bold text-gray-1000'>Latest Posts</p>
          <div className='max-width: 504px; width: 100%; margin: 0 auto'>
            <iframe
              src='https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:7318570156899614721'
              height='526'
              width='100%'
              frameborder='0'
              allowfullscreen=''
